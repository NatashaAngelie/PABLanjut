...
import edu.uph.m23si1.aplikasipertama.api.KotaResponse;
import edu.uph.m23si1.aplikasipertama.api.ProvinsiResponse;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //panggil API
        apiService.getProvinces().enqueue(new Callback<ProvinsiResponse>() {
            @Override
                ...
                if(response.isSuccessful() && response.body()!=null){
                    ...
                    sprProvinsi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            apiService.getCities(selected.getCode()).enqueue(new Callback<KotaResponse>() {
                                @Override
                                public void onResponse(Call<KotaResponse> call, Response<KotaResponse> response) {
                                    if(response.isSuccessful() && response.body()!=null){
                                        ...
                                        sprKota.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                            @Override
                                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                Kota selectedKota = kotaList.get(position);
                                                Toast.makeText(RegisterActivity.this,
                                                        "Kode : "+ selectedKota.getCode()+ " Nama Kota : "+ selectedKota.getName(),
                                                        Toast.LENGTH_LONG).show();
                                            }
